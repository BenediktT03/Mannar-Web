...
Öffne http://localhost:1337/admin
Erstelle deinen Admin-Account
Gehe zu Content Manager → User → Create new entry
Erstelle Frontend-User (Username: mitarbeiter, Password: Test123!, Role: Authenticated)
5. Live Editor testen
Gehe zu http://localhost:3000/login
Login mit mitarbeiter / Test123!
Klicke "✨ Live Editor öffnen"
Erstelle deine erste Word Cloud!
🛠️ Lokale Entwicklung
...
Save und Restart Strapi
Settings → Roles → Authenticated → Permissions aktivieren
...
Word Cloud erstellen: "Neue Word Cloud erstellen"
Titel & Beschreibung: Grundinformationen eingeben
Farben definieren: Color Picker für alle Bereiche
Wörter hinzufügen: Text, Gewichtung, Farbe, Links
Live-Vorschau prüfen: Real-time Darstellung
Speichern & Publishen: Direkt live auf der Website
📦 Deployment
Backend auf Render
...
New + → Web Service
Repository: Mannar-Web auswählen
Konfiguration:
...
Settings → Domains
Add Domain → Domain eingeben
DNS-Einstellungen beim Provider:
Type: A
Name: @
Value: 76.76.19.61
TTL: 15 Minuten
...
Browser-Check in API Functions:
...
DynamicStyles Component prüfen:
...
Push Feature Branch: git push origin feature/neue-funktion
GitHub PR öffnen: Detailed description mit Screenshots/GIFs
...
🎯 Phase 3: Drag & Drop Interface + Advanced Theming (Q2 2025)
🧩 Phase 4: Page Builder System + Multi-User Collaboration (Q3 2025)
🌍 Phase 5: Internationalization + AI Features (Q4 2025)
Community
⭐ GitHub Stars: Growing
🍴 Forks: Open Source Community
📝 Issues: Actively maintained
💬 Discussions: Feature requests welcome
Built with ❤️ by Benedikt Thomma for Mannar's Spiritual Guidance Platform
